...
set.seed(443332)
replicated_model5<-replicate(10, fix_split_train(boruta_output_l = Boruta_BacFun_Biomass,
                                                ps_object_l = CSS_BacFunBulkRhizo_ps_l,
                                                variable_to_be_classified ="shoot_biomass" ))
save(replicated_model5, file = "./Data/replicated_model5.RData")
...
load( file = "./Data/replicated_model5.RData")
