...
replicated_model_train_test_l<-c(replicated_model[1,], replicated_model2[1,], replicated_model3[1,])
replicated_model_boruta_feature_rf_repeatedcv <-c(replicated_model[2,], replicated_model2[2,], replicated_model3[2,])
