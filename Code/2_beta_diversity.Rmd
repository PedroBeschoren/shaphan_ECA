...
>>>>>>> 3e1df8c7898950fd6f13396e0e3f20791701a716
...
acessing and maanipulating lists
```{r}
CSS_BacFun_ps_l
...
CSS_BacFun_ps_l$Bac
CSS_BacFun_ps_l[1]
str(CSS_BacFun_ps_l[[2]])

lapply(CSS_BacFun_ps_l, function(x)
  otu_table(x)[1:10,1:10])
...
CSS_bac_ps_sampletype_l$bulk_soil<-subset_samples(CSS_bac_ps_sampletype_l$bulk_soil, sample_names(CSS_bac_ps_sampletype_l$bulk_soil) !="93B")
...
NMDS_plots_l<-NMDS_calculation_l(physeq_l = CSS_bac_ps_sampletype_l, 
                                 ordination_output = NMDS_Bac_l )
NMDS_plots_l
...
beta_disp_plotAndTest(phyloseq_list = CSS_bac_ps_filt_l,
                      group = "frass_source")
