...
deseq_3add_l <- lapply (unnormalized_BacFun_ps_l_bac_ps_filt_l, function (x) phyloseq_to_deseq2(x, ~ frass_source*frass_treatment*frass_dose))
deseq_3add_l <- lapply (deseq_3add_l, function (x) DESeq(x, test="Wald", fitType="parametric"))
...
#defien a function that takes a phyloseq object and returns heat trees
