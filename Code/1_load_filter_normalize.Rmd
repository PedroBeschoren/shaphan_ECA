...
The sample names on the OTU table do not match the sample names on the metadata. this will remove unecessary charathers from the sample anmes of the otu tables
...
names(CSS_bac_ps_sampletype_l$bulk_soil@sam_data)
