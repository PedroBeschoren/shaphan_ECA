...
The sample names on the OTU table do not match the sample names on the metadata. this will remove unnecessary characters from the sample names of the otu tables

```{r}

# remove any number of numeric characters([0-9]+) followed by the constant (_ID2577_16S-) and then any number of numeric chartaers up to and including a "-" ([0-9]+-)
...
## 2.1 - load ITS data and build Fun phyloseq object
...
```{r}
#adjust sample names
# remove any number of numeric charters([0-9]+) followed by the constant (_ID2577_ITS-) and then any number of numeric chartaers up to and including a "-" ([0-9]+-)
...
#fungi has 383 samples on otu table instead of 404, is it expected?
