...
rarefied_BacFun_ps_sampletype_FrassTrestemnt_l<-lapply(rarefied_BacFun_ps_l, function (x)
  metagMisc::phyloseq_sep_variable(x, variable = c("sample_type", "frass_treatment")))
